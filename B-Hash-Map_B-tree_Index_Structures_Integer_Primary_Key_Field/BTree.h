...
typedef struct TableA_RecordData* TableA_RecordData;

typedef int BTreePrimaryKey;
...
/* Record data - row of the table TableA that is linked to the B-tree index structure. */

struct TableA_RecordData
{
...
/*
*  Initializes and creates the record data of the TableA.
*
...
/*
*  Receives the primary key field of the TableA.
*
...
/*
*  Receives the generic field data of TableA.
*
