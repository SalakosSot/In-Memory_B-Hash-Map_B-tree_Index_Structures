...
void InitializeBHashMap(
        ...
        int BHashMap_Level_Size,   // Set of BHashMap B-tree index structures.
        int BTreeNodeSize          // Maximum record references that can be stored in a B-tree structure node of the BHashMap.
...
bool BHashMapSelectData(
        ...
        BTreePrimaryKey (*Get_Record_FieldData)(BTreeData)   // Receives the generic field data of the table that is linked to the BHashMap B-tree.
